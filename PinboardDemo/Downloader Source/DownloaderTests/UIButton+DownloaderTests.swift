//
//  UIButton+DownloaderTests.swift
//  PinboardDemo
//
...
class UIButton_DownloaderTests: DiskTestCase {
    ...
    func testImageFormat_Default() {
        ...
        let resizer = ImageResizer(size: formatSize, scaleMode: .AspectFit, allowUpscaling: false, compressionQuality: DownloaderGlobals.UIKit.DefaultFormat.CompressionQuality)
    ...
    func testBackgroundImageFormat_Default() {
        ...
        let resizer = ImageResizer(size: formatSize, scaleMode: .Fill, allowUpscaling: true, compressionQuality: DownloaderGlobals.UIKit.DefaultFormat.CompressionQuality)
        let image = UIImage.imageWithColor(UIColor.red)
