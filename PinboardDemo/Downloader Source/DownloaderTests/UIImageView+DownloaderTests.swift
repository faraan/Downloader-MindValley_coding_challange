//
//  UIImageView+DownloaderTests.swift
//  PinboardDemo
//
...
class UIImageView_DownloaderTests: DiskTestCase {
    ...
    func testFormatWithSize() {
        ...
        let resizer = ImageResizer(size: size, scaleMode: scaleMode, allowUpscaling: true, compressionQuality: DownloaderGlobals.UIKit.DefaultFormat.CompressionQuality)
        
        let format = DownloaderGlobals.UIKit.formatWithSize(size, scaleMode: scaleMode)
        
        XCTAssertEqual(format.diskCapacity, DownloaderGlobals.UIKit.DefaultFormat.DiskCapacity)
    ...
    func testFormat_Default() {
        let cache = Shared.imageCache
        let resizer = ImageResizer(size: sut.bounds.size, scaleMode: sut.hnk_scaleMode, allowUpscaling: true, compressionQuality: DownloaderGlobals.UIKit.DefaultFormat.CompressionQuality)
    ...
    func testSetImageFromURL_MemoryMiss() {
        let URL = Foundation.URL(string: "http://Downloader.io")!
    ...
    func testSetImageFromURL_WhenPreviousSetImageFromURL() {
        ...
        let URL1 = URL(string: "http://Downloader.io/1.png")!
        sut.contentMode = .center // No resizing
        ...
        let URL2 = URL(string: "http://Downloader.io/2.png")!
